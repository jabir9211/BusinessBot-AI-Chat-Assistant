...
function businessbot_chat_assist_ui() {
    ...
    ?>
    <button id="ai-chat-launcher" class="ai-launcher" type="button" style="display: none;" aria-label="<?php esc_attr_e('Open chat', 'businessbot-ai-chat'); ?>" title="<?php esc_attr_e('Open chat', 'businessbot-ai-chat'); ?>">
    ...
    <div id="ai-chat-widget" class="ai-widget" style="display: none;" aria-live="polite" aria-label="<?php esc_attr_e('AI Chat Widget', 'businessbot-ai-chat'); ?>">
        <div class="ai-header">
            <div class="ai-header-left">
                ...
                <div class="ai-header-texts">
                    <h2 class="ai-header-title"><?php esc_html_e('AI Support Assistant', 'businessbot-ai-chat'); ?></h2>
                    <p class="ai-status"><span class="ai-status-dot" aria-hidden="true"></span><?php esc_html_e('Online', 'businessbot-ai-chat'); ?></p>
                </div>
            </div>
            <div class="ai-header-actions">
                <button id="ai-chat-menu" class="ai-header-btn" type="button" aria-label="<?php esc_attr_e('More options', 'businessbot-ai-chat'); ?>" title="<?php esc_attr_e('More options', 'businessbot-ai-chat'); ?>">
                    <svg class="ai-svg-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                ...
                <button id="ai-chat-minimize" class="ai-header-btn" type="button" aria-label="<?php esc_attr_e('Minimize chat', 'businessbot-ai-chat'); ?>" title="<?php esc_attr_e('Minimize chat', 'businessbot-ai-chat'); ?>">
                ...
                <button id="ai-chat-close" class="ai-header-btn" type="button" aria-label="<?php esc_attr_e('Close chat', 'businessbot-ai-chat'); ?>" title="<?php esc_attr_e('Close chat', 'businessbot-ai-chat'); ?>">
                    <svg class="ai-svg-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        ...
        <div class="ai-input-area">
            <label for="ai-chat-input" class="screen-reader-text"><?php esc_html_e('Message', 'businessbot-ai-chat'); ?></label>
            <div class="ai-input-shell">
                ...
                <button id="ai-chat-send" type="button" aria-label="<?php esc_attr_e('Send message', 'businessbot-ai-chat'); ?>" title="<?php esc_attr_e('Send message', 'businessbot-ai-chat'); ?>">
                    <svg class="ai-svg-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                        <path d="M3 11.5 20 4l-5.6 16-3.4-5.2-8-3.3Z" fill="currentColor"></path>
                    </svg>
                </button>
            </div>
            <p class="ai-footer-note"><span aria-hidden="true">✦</span> <?php esc_html_e('Powered by BusinessBot', 'businessbot-ai-chat'); ?></p>
        </div>
    </div>
    <?php
